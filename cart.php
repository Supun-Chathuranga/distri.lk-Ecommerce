			...
			<div class="col-md-12">
				...
				<div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        $i=0;
                        foreach($_SESSION['cart_p_discount'] as $key => $value) 
                        {
                            $i++;
                            $arr_cart_p_discount[$i] = $value;
                        }
                        ...
                        <tr>
                            ...
                            <td><?php echo $arr_cart_p_discount[$i]; ?>%</td>
                            <td><?php echo $_SESSION['cart_p_itemcolor'][$i]; ?></td>
                            ...
                            <td class="text-right">
                                <?php
                                $row_total_price = ((int)$arr_cart_p_current_price[$i]*(int)$arr_cart_p_qty[$i])*((100-$arr_cart_p_discount[$i])/100);
                ...
                <div class="cart-buttons">
                    <ul>
                        <li><input type="submit" value="<?php echo LANG_VALUE_20; ?>" class="btn " style="background-color:#0C7575; color:white; border-radius:25px" name="form1"></li>
                        <li><a href="index.php" class="btn " style="background-color:#0C7575; color:white; border-radius:25px"><?php echo LANG_VALUE_85; ?></a></li>
                        <li><a href="checkout.php" class="btn " style="background-color:#0C7575; color:white; border-radius:25px"><?php echo LANG_VALUE_23; ?></a></li>
                    </ul>
                </div>
                </form>
                <?php endif; ?>
