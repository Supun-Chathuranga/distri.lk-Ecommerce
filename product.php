...
if(isset($_POST['form_add_to_cart'])) {
    ...
    if(isset($_SESSION['cart_p_id']))
    {
        ...
        if($added == 1) {
           $error_message1 = 'This product is already added to the shopping cart.' . $_POST['coloritems'];
        } else {
            ...
            $_SESSION['cart_p_discount'][$new_key] = $_POST['p_discount'];
            $_SESSION['cart_p_itemcolor'][$new_key] = $_POST['coloritems'];
            echo $_POST['coloritems'];
            $_SESSION['cart_p_name'][$new_key] = $_POST['p_name'];
            $_SESSION['cart_p_featured_photo'][$new_key] = $_POST['p_featured_photo'];

            $success_message1 = 'Product is added to the cart successfully! ' . $_POST['coloritems'];
        }
    ...
    else
    {
        ...
        $_SESSION['cart_p_discount'][1] = $_POST['p_discount'];
        $_SESSION['cart_p_itemcolor'][1] = $_POST['coloritems'];
						...
						<div class="col-md-7">
                            ...
                            <div class="p-quantity" >
                               ...
                               <?php if(isset($size)): ?>
                                    ...
                                    <div class="col-md-12 mb_10">
                                        <?php echo "Sizes" //LANG_VALUE_52; ?> <br>
                                    ...
                                    $statement = $pdo->prepare("SELECT * FROM tbl_color WHERE color_id IN ($color_ids)");
                                    $statement->execute();
                                    $colors = $statement->fetchAll(PDO::FETCH_ASSOC);
                                    ?>
                                    ...
                                    <?php if (!empty($colors)): ?>
                                        <div class="col-md-12 mb_10">
                                            <?php echo "Colors"; //LANG_VALUE_53; ?> <br>
                                            <?php
                                            $colorList = array();
                                            foreach ($colors as $row) {
                                                $colorList[] = $row['color_name'];
                                            }
                                            $colorString = implode(", ", $colorList);
                                            ?>
                                            <div class="col-md-12">
                                                <p><?php echo $colorString; ?></p>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                <?php endif; ?>
                                ...
                                function updateSelection() {
                                    var colorSelections = document.getElementsByName("color[]");
                                    var quantitySelections = document.getElementsByName("pqty");
                                    var colorValues = "";
                                    var quantityValues = "";
                                    var colorItems = "";
                                    for (var i = 0; i < colorSelections.length; i++) {
                                        colorValues += getColorName(colorSelections[i].value) + ", ";
                                        quantityValues += parseInt(quantitySelections[i].value) + ", "; // convert to integer
                                        
                                        if (i+1 == colorSelections.length)
                                        {
                                            colorItems += getColorName(colorSelections[i].value) + "=" + quantitySelections[i].value;
                                        } else {
                                            colorItems += getColorName(colorSelections[i].value) + "=" + quantitySelections[i].value + "\n";
                                        }
                                    ...
                                    var itemcolor = document.getElementById("coloritems");
                                    itemcolor.value = colorItems;

                                    colorValues = colorValues.slice(0, -2);
                                    quantityValues = quantityValues.slice(0, -2);
                                    document.getElementById("color_selection").innerHTML = "Selected colors: " + colorValues;
                                    document.getElementById("quantity_selection").innerHTML = "Selected quantities: " + quantityValues;
                                    console.log(typeof(quantityValues)); // print the type of quantityValues variable
                                    var totalQuantity = 0;
                                    quantitySelections.forEach(function(selection) {
                                        totalQuantity += parseInt(selection.value);
                                    });
                                ...
                                function getColorName(colorId) {
                                    var colorSelections = document.getElementsByName("color[]");
                                    for (var i = 0; i < colorSelections.length; i++) {
                                        var option = colorSelections[i].options[colorSelections[i].selectedIndex];
                                ...
                                <p style="display:none;" id="color_selection">Selected colors:</p>
                                <p style="display:none;" id="quantity_selection">Selected quantities:</p>
							...
							<div class="p-quantity">
                                ...
                                <span >
                                    <?php if($p_m_qty >'1'): ?>
                                         <!-- new change -->
                                        <h3 style="margin-bottom: 20px;">Minimum Quantity : <?php echo $p_m_qty; ?></h3>
                                    <?php endif; ?> 
                                        <?php echo ""; ?>
                                ...
                                <span >
                                    <?php if($p_discount>0){     ?>
                                         <!-- new change -->
                                        <h3 style="margin-bottom: 20px;">Discount : <?php echo $p_discount; ?>%</h3> 
                                        <?php } ?>
                               
                                       
                                    <input type="hidden" value="<?php echo $p_discount; ?>" name="p_discount"/>
                                    <input type="hidden" name="coloritems" id="coloritems" />
                                </span>
							...
							<?php
                                ...
                                $whatsappLink = "https://wa.me/message/WTUKKDVOWN2QP1";
                                ?>
							<div class="btn-cart btn-cart1 ">
                                <!-- new change -->
                                <input type="submit" style="background-color:#0C7575; border-radius:25px;margin-bottom: 20px;" value="<?php echo "Send Inquiry"//LANG_VALUE_154; ?>"   onclick="window.open('<?php echo $whatsappLink; ?>', '_blank')" >
							</div>
                            </form>
							<div class="share">
