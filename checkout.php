        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <?php
                                    $row_total_price = ($arr_cart_p_current_price[$i]*$arr_cart_p_qty[$i])*((100-$arr_cart_p_discount[$i])/100);
                ...
                <div class="cart-buttons">
                    <ul>
                        <li><a href="cart.php" class="btn " style="background-color:#0C7575; color:white; border-radius:25px"><?php echo LANG_VALUE_21; ?></a></li>
                    </ul>
                </div>
		                	...
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
                                    ...
                                    <form class="paypal" action="<?php echo BASE_URL; ?>payment/paypal/payment_process.php" method="post" id="paypal_form" target="_blank">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <input type="submit" class="btn" style="background-color:#0C7575; color:white" value="<?php echo LANG_VALUE_46; ?>" name="form1">
                                        </div>
                                    </form>
                                    ...
                                    <form action="payment/bank/init.php" method="post" id="bank_form">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <input type="submit" class="btn" style="background-color:#0C7575; color:white" value="<?php echo LANG_VALUE_46; ?>" name="form3">
                                        </div>
                                    </form>
