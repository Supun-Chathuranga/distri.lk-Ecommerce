...
if (isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        // Send email for confirmation of the account
         $to = $_POST['cust_email'];
         $sender = 'support@distri.lk';
         $subject = LANG_VALUE_150;
         $verify_link = 'https://www.distri.lk/verify.php?email='.$to.'&token='.$token;
         $message = '
 '.LANG_VALUE_151.'<br><br>

 <a href="'.$verify_link.'">'.$verify_link.'</a>';

         $headers = "From: support@distri.lk" . BASE_URL . "\r\n" .
                    "Reply-To: support@distri.lk" . BASE_URL . "\r\n" .
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for=""></label>
                                    <input type="submit" class="btn" style="background-color:#0C7575; color:white;" value="<?php echo LANG_VALUE_15; ?>" name="form1">
                                </div>
                            </div>
                        </div>                        
                    </form>
