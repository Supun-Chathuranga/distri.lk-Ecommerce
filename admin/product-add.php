			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Old Price <br><span style="font-size:10px;font-weight:normal;">(In LKR)</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Discount <br><span style="font-size:10px;font-weight:normal;">%</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Minimum Quantity <span>*</span></label>
							<div class="col-sm-4">
								<input type="text" name="p_m_qty" class="form-control"> 
							</div>
						</div>
						<div class="form-group">
